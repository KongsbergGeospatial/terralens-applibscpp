...
QT       += qml quick core gui gui-private widgets

TEMPLATE = lib
TARGET = TLQml

SOURCES += $$PWD/src/TerraLens/ViewportItem.cpp \
    $$PWD/src/TerraLens/ViewportItem2D.cpp \
    $$PWD/src/TerraLens/ViewportItem3D.cpp

HEADERS  += $$PWD/include/TerraLens/ViewportItem.h \
        $$PWD/include/TerraLens/ViewportItem2D.h \
        $$PWD/include/TerraLens/ViewportItem3D.h
